...
class Warrior(object):
    def __init__(self, x, y, width, height, speed):
        ...
        # spell animation
        self.sright = [pygame.image.load("warrior_image/SR1.png"), pygame.image.load("warrior_image/SR2.png"),
                    pygame.image.load("warrior_image/SR3.png"), pygame.image.load("warrior_image/SR4.png"),
                    pygame.image.load("warrior_image/SR5.png"), pygame.image.load("warrior_image/SR6.png"),
                    pygame.image.load("warrior_image/SR7.png"), pygame.image.load("warrior_image/SR8.png"),
                    pygame.image.load("warrior_image/SR9.png")]

        self.sleft = [pygame.image.load("warrior_image/SL1.png"), pygame.image.load("warrior_image/SL2.png"),
                    pygame.image.load("warrior_image/SL3.png"), pygame.image.load("warrior_image/SL4.png"),
                    pygame.image.load("warrior_image/SL5.png"), pygame.image.load("warrior_image/SL6.png"),
                    pygame.image.load("warrior_image/SL7.png"), pygame.image.load("warrior_image/SL8.png"),
                    pygame.image.load("warrior_image/SL9.png")]
        ...
        self.SS = [pygame.image.load("warrior_image/SF1.png"), pygame.image.load("warrior_image/SF2.png"),
                        pygame.image.load("warrior_image/SF3.png"), pygame.image.load("warrior_image/SF4.png"),
                        pygame.image.load("warrior_image/SF5.png"), pygame.image.load("warrior_image/SF5.png"),
                        pygame.image.load("warrior_image/SF6.png"), pygame.image.load("warrior_image/SF6.png"),
                        pygame.image.load("warrior_image/SF7.png")]

        self.SW = [pygame.image.load("warrior_image/SW1.png"), pygame.image.load("warrior_image/SW2.png"),
                       pygame.image.load("warrior_image/SW3.png"), pygame.image.load("warrior_image/SW4.png"),
                       pygame.image.load("warrior_image/SW5.png"), pygame.image.load("warrior_image/SW5.png"),
                       pygame.image.load("warrior_image/SW6.png"), pygame.image.load("warrior_image/SW6.png"),
                       pygame.image.load("warrior_image/SW7.png")]
